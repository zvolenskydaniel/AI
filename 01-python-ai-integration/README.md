...
- [Prompt Design Fundamentals](#prompt-design-fundamentals)
  ...
  - [Practical Examples](#practical-examples)
    - [Dynamic Input (Country as Variable)](#dynamic-input-country-as-variable)
    - [Introduction to Temperature (Controlled Creativity)](#introduction-to-temperature-controlled-creativity)
    - [Prompt Development Techniques](#prompt-development-techniques)
- [Design Mindset](#design-mindset)
- [Working with Structured Outputs](#working-with-structured-outputs)
  - [Instruct an LLM to Return JSON Output](#instruct-an-llm-to-return-json-output)
  - [JSON Schema Validation](#json-schema-validation)
- [Error Handling and Safety Considerations](#error-handling-and-safety-considerations)
  - [Error Handling Pattern Example](#error-handling-pattern-example)
  - [Retry Strategy](#retry-strategy)
  - [Safety Considerations](#safety-considerations)
    - [Prompt Injection Awareness](#prompt-injection-awareness)
    - [Output Filtering & Constraints](#output-filtering--constraints)
    - [Determinism for Automation](#determinism-for-automation)
