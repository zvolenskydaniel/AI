...
- [Chains, Tools, and Memory](#chains-tools-and-memory)
  ...
  - [Chains](#chains)
    - [Minimal LangChain Chain Example](#minimal-langchain-chain-example)
  - [Tools](#tools)
    - [Conceptual Tool Example](#conceptual-tool-example)
  - [Memory](#memory)
    - [Manual Short-Term Memory Example](#manual-short-term-memory-example)
    - [Manual Long-Term Memory Example](#manual-long-term-memory-example)
    - [Framework-Provided Memory](#framework-provided-memory)
    - [Memory Growth and Trim Messages](#memory-growth-and-trim-messages)
    - [Memory Growth and Summarization](#memory-growth-and-summarization)
    - [Memory Strategy Comparison Table](#memory-strategy-comparison-table)
- [Retrieval-Augmented Generation (RAG)](#retrieval-augmented-generation-rag)
  - [Minimal RAG Example](#minimal-rag-example)
  - [Explicit Retrieval + Generation Pipeline Example](#explicit-retrieval--generation-pipeline-example)
- [Document Indexing and Querying](#document-indexing-and-querying)
  - [Document Loading](#document-loading)
    - [Supported Sources](#supported-sources)
    - [Loading Files](#loading-files)
    - [Loading Specific File Types](#loading-specific-file-types)
    - [Recursive Loading](#recursive-loading)
    - [Multiple Sources](#multiple-sources)
    - [Common Document Loading Pitfalls](#common-document-loading-pitfalls)
  ...
  - [Document Chunking Strategies](#document-chunking-strategies)
    ...
    - [Paragraph and Section-Based Chunking](#paragraph-and-section-based-chunking)
    - [Sliding Window Chunking](#sliding-window-chunking)
    - [Inspecting Chunks](#inspecting-chunks)
    - [Choosing a Strategy](#choosing-a-strategy)
  - [Embeddings and Index Construction](#embeddings-and-index-construction)
    - [What Embeddings Represent](#what-embeddings-represent)
    - [How Chunking Affects Embeddings](#how-chunking-affects-embeddings)
    - [Building an Index from Documents](#building-an-index-from-documents)
    - [Common Embedding Pitfalls](#common-embedding-pitfalls)
  - [Querying and Retrieval](#querying-and-retrieval)
    - [Basic Semantic Querying](#basic-semantic-querying)
    - [Semantic Search](#semantic-search)
    - [Metadata-Base Filtering](#metadata-base-filtering)
    - [Debugging Retrieval](#debugging-retrieval)
  - [Combining Metadata and Chunking](#combining-metadata-and-chunking)
    - [Load Document with Metadata](#load-document-with-metadata)
    - [Apply a Chunking Strategy (Sentence-Based)](#apply-a-chunking-strategy-sentence-based)
    - [Inspect Chunks + Metadata](#inspect-chunks--metadata)
    - [Query Using Metadata Filtering](#query-using-metadata-filtering)
  - [Common Indexing Pitfalls](#common-indexing-pitfalls)
- [Modular AI pipelines](#modular-ai-pipelines)
  - [Composable Components](#composable-components)
  - [Swapping Retrievers, LLMs, Tools](#swapping-retrievers-llms-tools)
    - [Swapping Retrievers](#swapping-retrievers)
    - [Swapping LLMs](#swapping-llms)
  ...
  - [Production-Ready Patterns](#production-ready-patterns)
    ...
    - [Fallbacks and Guardrails](#fallbacks-and-guardrails)
    - [Stateless Core + Optional Memory](#stateless-core--optional-memory)
- [Summary](#summary)
